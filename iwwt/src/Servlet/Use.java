...
public class Use extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/data", "root", "12345");

            // Prepare and execute SQL insert statement
            PreparedStatement ps = con.prepareStatement("INSERT INTO datatable (Username, Password) VALUES (?, ?)");
